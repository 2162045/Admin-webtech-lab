  ...
  <body>
    ...
    <div id="wrapper">
      <div class="container">
        ...
        $sql = mysqli_query($conn,"SELECT * from user WHERE request='Pending' ORDER BY $field $sort");
        
        
           echo "<table class='table table-striped table-bordered table-hover warning id='dataTables-example';>";
            
            echo'
            <th><a href="clientreq.php?sorting='.$sort.'&field=id_no">ID</a></th>
            <th><a href="clientreq.php?sorting='.$sort.'&field=role">Username</a></th>
            <th><a href="clientreq.php?sorting='.$sort.'&field=firstName">First Name</a></th>
            <th><a href="clientreq.php?sorting='.$sort.'&field=lastName">Last Name</a></th>
            <th><a href="clientreq.php?sorting='.$sort.'&field=contactNumber">Contact Number</a></th>
            <th><a href="clientreq.php?sorting='.$sort.'&field=address">Address</a></th>
            <th><a href="clientreq.php?sorting='.$sort.'&field=email">Email</a></th>
            <th><a href="clientreq.php?sorting='.$sort.'&field=request">Request</a></th>
            <th>Approval</th>';
